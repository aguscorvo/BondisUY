...
Despliegue local con aplicaciones instaladas
...
A continuación, se deberá publicar las capas necesarias en Geoserver, de forma de que la aplicación pueda acceder a las mismas para cumplir con sus funcionalidades. Ver sección de publicación de capas en Geoserver.
...
La información para publicar las mismas se puede encontrar en:
Recursos/CapasSQLGEOSEREVER.txt
