...
a persistence unit "bondisuyPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "bondisuy\pom.xml":
...
artifacts ("bondisuy-ejb.jar" and "bondisuy-web.war") are already built. You can build
